...
public class VentanaToken extends javax.swing.JDialog {
    ...
    private Automata ver;

    public VentanaToken(java.awt.Frame parent, boolean modal, Automata ver) {
        super(parent, modal);
        this.ver = ver;
        initComponents();
        setLocationRelativeTo(parent);
        ver.mostrarTokens(taTokens);
        ver.imprimirContadorTokens(taNumVeces);
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("Liberation Serif", 0, 32)); // NOI18N
